...
VERSION="$2"
ARCH="$3"
OUTPUT_FILE="JSTorrent_${VERSION}_${ARCH}.pkg"
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
INSTALLER_SCRIPTS="$SCRIPT_DIR/../installers/macos/scripts"
IDENTIFIER="com.jstorrent.desktop"
...
echo "Building .pkg installer for JSTorrent v${VERSION} (${ARCH})..."
echo "  App: $APP_PATH"
...
cp -R "$APP_PATH" "$PKGROOT/Applications/JSTorrent.app"

# Build component package
COMPONENT_PKG="$WORK_DIR/jstorrent-component.pkg"
...
<installer-gui-script minSpecVersion="2">
    ...
    <choice id="default" title="JSTorrent">
        <pkg-ref id="$IDENTIFIER"/>
    </choice>
    <pkg-ref id="$IDENTIFIER" version="$VERSION" onConclusion="none">jstorrent-component.pkg</pkg-ref>
