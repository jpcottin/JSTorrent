...
BUILD_APP="$SCRIPT_DIR/../target/release/bundle/macos/JSTorrent.app"
if [ ! -d "$BUILD_APP" ]; then
...
PKG_FILE="JSTorrent_${VERSION}_${ARCH_LABEL}.pkg"
if [ ! -f "$PKG_FILE" ]; then
...
xattr -cr "$HOME/Applications/JSTorrent.app"

echo "Installed: $HOME/Applications/JSTorrent.app"
