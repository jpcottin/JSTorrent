...
echo "CI will build and upload to App Store Connect: https://github.com/kzahel/jstorrent/actions"
echo ""
echo "After Apple notarization approval:"
echo "  1. Download ADP from AltStore PAL REST API"
echo "  2. Upload ADP to GitHub Release"
echo "  3. Run: scripts/ios-finalize-release.sh $VERSION <adp-url>"
