 ...
 *
 * Client-local copy of the engine's createTorrentSourceFromSession to avoid
 * pulling in the full engine in the popup video player entry point.
 */

import type { ByteRangeStreamingSession } from '@jstorrent/engine'
