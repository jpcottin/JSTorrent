...
// Legacy state push loop has been removed.
// State is now pushed via the SubscriptionManager in subscriptions.ts
// UI subscribes to data it needs, engine pushes all subscribed data in batched payloads.
