...
export interface ConnectionConfig {
  ...
  maintenanceMinInterval: number // Min interval when urgent (ms)
  maintenanceMaxInterval: number // Max interval when full (ms)
  // Slow peer detection
...
export class ConnectionManager {
   ...
   */
  async fillSlots(globalLimitCheck?: () => boolean): Promise<number> {
